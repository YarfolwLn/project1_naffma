fun main() {
    ...
    while (true) {
        ...
        println("1. RLE-кодирование строки")
        println("2. Анализ символов в строке")
        println("3. Конвертер десятичных чисел в двоичные")
        println("4. Калькулятор")
        println("5. Поиск целочисленного показателя степени")
        println("6. Генератор нечетного числа из двух цифр")
        println("0. Выход")
...
// Программа 3: Конвертер в двоичную систему
fun runProgram3() {
...
// Программа 5: Поиск показателя степени
fun runProgram5() {
    println("\n--- Поиск целочисленного показателя степени ---")
...
// Программа 6: Генератор нечетного числа
fun runProgram6() {
    println("\n--- Генератор нечетного числа из двух цифр ---")
